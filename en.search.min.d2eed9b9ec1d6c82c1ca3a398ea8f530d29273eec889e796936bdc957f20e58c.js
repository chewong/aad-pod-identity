...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/aad-pod-identity/flexsearch.min.js');loadScript('/aad-pod-identity/en.search-data.min.09f4b07bd9cd4855b60544e444e1adec671d00104f2abf83d11c881630b64613.js',function(){input.required=false;search();});}
